...
export default new Vuex.Store({
	...
	mutations: {
		...
		setSettings (state, value) {
			state.meta.siteName = value.siteName
			state.meta.siteDescriptionInfoMain = value.siteDescriptionInfoMain
			state.meta.siteDescriptionInfoSecondary = value.siteDescriptionInfoSecondary
			state.meta.siteAdvantages = value.siteAdvantages
			state.meta.siteQuestionsAndAnswersMain = value.siteQuestionsAndAnswersMain
			state.meta.siteQuestionsAndAnswersSecondary = value.siteQuestionsAndAnswersSecondary
			state.meta.siteContactMain = value.siteContactMain
			state.meta.siteOurTeam = value.siteOurTeam
			state.meta.siteFooterMain = value.siteFooterMain
			state.meta.siteFooterSecondary = value.siteFooterSecondary
			state.meta.siteAddress = value.siteAddress
			state.meta.siteCopyrite = value.siteCopyrite
			state.meta.showDescription = value.showDescription
			state.meta.showQuestionsAndAnswers = value.showQuestionsAndAnswers
			state.meta.showFooter = value.showFooter
			state.meta.showTeam = value.showTeam
			state.meta.showContact = value.showContact
			state.meta.showAdvantages = value.showAdvantages
		},
